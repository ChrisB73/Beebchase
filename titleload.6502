{ORG &2600
;Note that the LZSA implementation below has been altered to allow assembly by beebasm
;This has included the removal of the forwards/backwards variants and the below version only
;decompresses backwards
...
;
; in:
; P% LZSA_SRC_LO and LZSA_SRC_HI contain the compressed raw block address
; P% LZSA_DST_LO and LZSA_DST_HI contain the destination buffer address
;
; out:
; P% LZSA_DST_LO and LZSA_DST_HI contain the last decompressed byte address, +1
;
; -----------------------------------------------------------------------------
...
;
; in:
; P% LZSA_SRC_LO/LZSA_SRC_HI must contain the address of the last byte of compressed data
; P% LZSA_DST_LO/LZSA_DST_HI must contain the address of the last byte of the destination buffer
;
; out:
; P% LZSA_DST_LO/LZSA_DST_HI contain the last decompressed byte address, -1
;
; -----------------------------------------------------------------------------
;
...
.OFFSET_9_BIT                            ; 01Z: 9 bit offset
   ROL A                                  ; carry: Z bit; A: xxxxxxx1 (carry known set from BCS OFFSET_9_BIT)
   ...
   BNE GOT_OFFSET_HI                    ; go store high byte, read low byte of match offset and prepare match
                                        ; (P%same as JMP GOT_OFFSET_HI but shorter)
...
.screendata
; Needs to be reverse compressed
incbin "bctitle.lzsa"
screenend=P%-1 
}
Print "Title end",~P%,&3000-P%
save "Title",&2600,P%
clear &2600,&2fff
